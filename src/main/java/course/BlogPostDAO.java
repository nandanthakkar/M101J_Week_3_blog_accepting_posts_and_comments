...
public class BlogPostDAO {
    ...
    public String addPost(String title, String body, List tags, String username) {
        ...
        Document post = new Document("permalink",permalink).append("title",title).append("body",body).append("author",username)
                .append("tags",tags).append("date",new Date()).append("comments", new ArrayList<Document>());
